 ...
 */
static inline uint32_t os_cputime_get32(void)
{
 ...
 */
static inline uint32_t os_cputime_usecs_to_ticks(uint32_t usecs)
{
 ...
 */
static inline uint32_t os_cputime_ticks_to_usecs(uint32_t ticks)
{
 ...
 */
static inline void os_cputime_delay_ticks(uint32_t ticks)
{
    xtimer_ticks32_t val = {.ticks32 = ticks};
