...
info-build:
	...
	$(info FEATURES_BLACKLIST (blacklisted features):)
	$(info          $(or $(sort $(FEATURES_BLACKLIST)), -none-))
	$(info FEATURES_USED_BLACKLISTED (used but blacklisted features):)
	$(info          $(or $(sort $(FEATURES_USED_BLACKLISTED)), -none-))
	$(info )
